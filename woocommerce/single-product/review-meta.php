...
<?php } else { ?>
	...
	<p class="meta">
        ...
        <time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>">
            <span class="woocommerce-review-date"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></span>
            <span class="woocommerce-review__dash">|</span>
            <span class="woocommerce-review-time"><?php echo esc_html( get_comment_date( wc_time_format() ) ); ?></span>
        </time>
	</p>
