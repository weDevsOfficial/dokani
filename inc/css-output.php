...
if ( ! function_exists( 'dokanee_base_css' ) ) {
	/**
	...
	function dokanee_base_css() {
		...
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'background_color' ] ) );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'text_color' ] ) );
		...
		// Visited links
		$css->set_selector( 'a:visited' )->add_property( 'color', esc_attr( $dokanee_settings[ 'link_color_visited' ] ) );
		...
		return apply_filters( 'dokanee_base_css_output', $css->css_output() );
	}
}

if ( ! function_exists( 'dokanee_advanced_css' ) ) {
	/**
	 * Generate the CSS in the <head> section using the Theme Customizer.
	 *
	 * @since 0.1
	...
	function dokanee_advanced_css() {
		...
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'top_bar_background_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'top_bar_link_color_hover' ] ) );

		// Header
		$css->set_selector( '.site-header' );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'header_background_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'site_title_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'content_text_color' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'content_background_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'content_link_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'content_link_hover_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'blog_post_title_hover_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'sidebar_widget_text_color' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'sidebar_widget_background_color' ] ) );

		// Sidebar widget links
		$css->set_selector( '.sidebar .widget a,.sidebar .widget a:visited' );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'sidebar_widget_link_color' ] ) );

		// Sidebar widget links on hover
		$css->set_selector( '.sidebar .widget a:hover' );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'sidebar_widget_link_hover_color' ] ) );

		// Sidebar widget title
		$css->set_selector( '.sidebar .widget .widget-title' );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'sidebar_widget_title_color' ] ) );

		// Footer widget
		$css->set_selector( '#footer-widgets' );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'footer_widget_text_color' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'footer_widget_bg_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'form_text_color' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'form_background_color' ] ) );
		$css->add_property( 'border-color', esc_attr( $dokanee_settings[ 'form_border_color' ] ) );
		...
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'form_text_color_focus' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'form_background_color_focus' ] ) );
		$css->add_property( 'border-color', esc_attr( $dokanee_settings[ 'form_border_color_focus' ] ) );

		// Form button
		$css->set_selector( 'button,html input[type="button"],input[type="reset"],input[type="submit"],a.button,a.button:visited' );
		$css->add_property( 'color', esc_attr( $dokanee_settings[ 'form_button_text_color' ] ) );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings[ 'form_button_background_color' ] ) );
		...
		$css->add_property( 'background-color', esc_attr( $dokanee_settings['back_to_top_background_color'] ) );
		$css->add_property( 'color', esc_attr( $dokanee_settings['back_to_top_text_color'] ) );

		$css->set_selector( '.dokanee-back-to-top:hover,.dokanee-back-to-top:focus' );
		...
		$css->set_selector( '.dokanee-products-view button:hover, .dokanee-products-view button:active, .dokanee-products-view button:focus, .dokanee-products-view button.active, .dokan-seller-view button:hover, .dokan-seller-view button:focus, .dokan-seller-view button:active, .dokan-seller-view button.active' );
		$css->add_property( 'color', esc_attr( $dokanee_settings['theme_color'] ) );
		...
		$css->set_selector( '.dokan-theme-dokanee input[type="submit"].dokan-btn-theme, .dokan-theme-dokanee a.dokan-btn-theme, .dokan-theme-dokanee .dokan-btn-theme' );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings['theme_color'] ) . '!important' );
		$css->add_property( 'border-color', esc_attr( $dokanee_settings['theme_color'] ) . '!important' );

		$css->set_selector( '.dokan-theme-dokanee input[type="submit"].dokan-btn-theme:hover, .dokan-theme-dokanee .dokan-btn-theme:hover, .dokan-theme-dokanee .dokan-btn-theme:focus' );
		$css->add_property( 'background-color', esc_attr( $dokanee_settings['theme_color'] ) . '!important' );
		...
		if ( function_exists( 'dokan' ) ) {
			...
			$css->add_property( 'color', esc_attr( $dokanee_settings[ 'store_header_title_color' ] ) );

			$css->set_selector( '.profile-info-summery' );
			$css->add_property( 'color', esc_attr( $dokanee_settings[ 'store_header_text_color' ] ) );

			$css->set_selector( 'div.profile-frame .store-banner .profile-info-box .store-info-column .store-meta-info a' );
			$css->add_property( 'color', esc_attr( $dokanee_settings['store_header_link_color'] ) );
		...
		return apply_filters( 'dokanee_colors_css_output', $css->css_output() );
	}
}

if ( ! function_exists( 'dokanee_font_css' ) ) {
	/**
	 * Generate the CSS in the <head> section using the Theme Customizer.
	 *
	 * @since 0.1
	...
	function dokanee_font_css() {
		...
		$og_defaults = dokanee_get_default_fonts( false );

		$css = new Dokanee_CSS;

		// Get our sub-navigation font size
		$subnav_font_size = $dokanee_settings['navigation_font_size'] >= 17 ? $dokanee_settings['navigation_font_size'] - 3 : $dokanee_settings['navigation_font_size'] - 1;

		// Create all of our font family entries
		$body_family = dokanee_get_font_family_css( 'font_body', 'dokanee_settings', dokanee_get_default_fonts() );
		$top_bar_family = dokanee_get_font_family_css( 'font_top_bar', 'dokanee_settings', dokanee_get_default_fonts() );
		$site_title_family = dokanee_get_font_family_css( 'font_site_title', 'dokanee_settings', dokanee_get_default_fonts() );
		...
		$footer_family = dokanee_get_font_family_css( 'font_footer', 'dokanee_settings', dokanee_get_default_fonts() );
		$buttons_family = dokanee_get_font_family_css( 'font_buttons', 'dokanee_settings', dokanee_get_default_fonts() );

		// Body
		$css->set_selector( 'body, button, input, select, textarea' );
		$css->add_property( 'font-family', $body_family );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'body_font_weight' ] ), $og_defaults[ 'body_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'body_font_transform' ] ), $og_defaults[ 'body_font_transform' ] );

		$css->set_selector( 'html, body' );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'body_font_size' ] ), $og_defaults[ 'body_font_size' ], 'px' );

		// Line hieght
		$css->set_selector( 'body' );
		$css->add_property( 'line-height', floatval( $dokanee_settings['body_line_height'] ), $og_defaults['body_line_height'] );

		// Paragraph margin
		$css->set_selector( 'p' );
		$css->add_property( 'margin-bottom', floatval( $dokanee_settings['paragraph_margin'] ), $og_defaults['paragraph_margin'], 'em' );

		// Top bar
		$css->set_selector( '.top-bar' );
		$css->add_property( 'font-family', $og_defaults[ 'font_top_bar' ] !== $dokanee_settings[ 'font_top_bar' ] ? $top_bar_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'top_bar_font_weight' ] ), $og_defaults[ 'top_bar_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'top_bar_font_transform' ] ), $og_defaults[ 'top_bar_font_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'top_bar_font_size' ] ), absint( $og_defaults[ 'top_bar_font_size' ] ), 'px' );

		// Site title
		$css->set_selector( '.main-title' );
		$css->add_property( 'font-family', $og_defaults[ 'font_site_title' ] !== $dokanee_settings[ 'font_site_title' ] ? $site_title_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'site_title_font_weight' ] ), $og_defaults[ 'site_title_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'site_title_font_transform' ] ), $og_defaults[ 'site_title_font_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'site_title_font_size' ] ), $og_defaults[ 'site_title_font_size' ], 'px' );

		// Site description
		$css->set_selector( '.site-description' );
		$css->add_property( 'font-family', $og_defaults[ 'font_site_tagline' ] !== $dokanee_settings[ 'font_site_tagline' ] ? $site_tagline_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'site_tagline_font_weight' ] ), $og_defaults[ 'site_tagline_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'site_tagline_font_transform' ] ), $og_defaults[ 'site_tagline_font_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'site_tagline_font_size' ] ), $og_defaults[ 'site_tagline_font_size' ], 'px' );

		// Navigation
		$css->set_selector( '.main-navigation a, .menu-toggle' );
		$css->add_property( 'font-family', $og_defaults[ 'font_navigation' ] !== $dokanee_settings[ 'font_navigation' ] ? $navigation_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'navigation_font_weight' ] ), $og_defaults[ 'navigation_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'navigation_font_transform' ] ), $og_defaults[ 'navigation_font_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'navigation_font_size' ] ), $og_defaults[ 'navigation_font_size' ], 'px' );
		...
		$css->add_property( 'font-family', $og_defaults[ 'font_widget_title' ] !== $dokanee_settings[ 'font_widget_title' ] ? $widget_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'widget_title_font_weight' ] ), $og_defaults[ 'widget_title_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'widget_title_font_transform' ] ), $og_defaults[ 'widget_title_font_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings[ 'widget_title_font_size' ] ), $og_defaults[ 'widget_title_font_size' ], 'px' );
		$css->add_property( 'margin-bottom', absint( $dokanee_settings['widget_title_separator'] ), absint( $og_defaults['widget_title_separator'] ), 'px' );

		// Widget font size
		$css->set_selector( '.sidebar .widget, .footer-widgets .widget' );
		$css->add_property( 'font-size', absint( $dokanee_settings['widget_content_font_size'] ), $og_defaults['widget_content_font_size'], 'px' );

		// Form button
		$css->set_selector( 'button:not(.menu-toggle),html input[type="button"],input[type="reset"],input[type="submit"],.button,.button:visited' );
		$css->add_property( 'font-family', $og_defaults[ 'font_buttons' ] !== $dokanee_settings[ 'font_buttons' ] ? $buttons_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'buttons_font_weight' ] ), $og_defaults[ 'buttons_font_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'buttons_font_transform' ] ), $og_defaults[ 'buttons_font_transform' ] );

		if ( '' !== $dokanee_settings[ 'buttons_font_size' ] ) {
		...
		// Footer
		$css->set_selector( '.site-info' );
		$css->add_property( 'font-family', $og_defaults[ 'font_footer' ] !== $dokanee_settings[ 'font_footer' ] ? $footer_family : null );
		$css->add_property( 'font-weight', esc_attr( $dokanee_settings[ 'footer_weight' ] ), $og_defaults[ 'footer_weight' ] );
		$css->add_property( 'text-transform', esc_attr( $dokanee_settings[ 'footer_transform' ] ), $og_defaults[ 'footer_transform' ] );
		$css->add_property( 'font-size', absint( $dokanee_settings['footer_font_size'] ), $og_defaults['footer_font_size'], 'px' );

		// Mobile
		$css->start_media_query( apply_filters( 'dokanee_mobile_media_query', '(max-width:768px)' ) );
		// Site title
		$mobile_site_title = ( isset( $dokanee_settings[ 'mobile_site_title_font_size' ] ) ) ? $dokanee_settings[ 'mobile_site_title_font_size' ] : '30';
		$css->set_selector( '.main-title' );
		$css->add_property( 'font-size', absint( $mobile_site_title ), false, 'px' );

		// H1
		$mobile_h1 = ( isset( $dokanee_settings[ 'mobile_heading_1_font_size' ] ) ) ? $dokanee_settings[ 'mobile_heading_1_font_size' ] : '30';
		$css->set_selector( 'h1' );
		$css->add_property( 'font-size', absint( $mobile_h1 ), false, 'px' );

		// H2
		$mobile_h2 = ( isset( $dokanee_settings[ 'mobile_heading_2_font_size' ] ) ) ? $dokanee_settings[ 'mobile_heading_2_font_size' ] : '25';
		$css->set_selector( 'h2' );
		$css->add_property( 'font-size', absint( $mobile_h2 ), false, 'px' );
		$css->stop_media_query();

		// Allow us to hook CSS into our output
		do_action( 'dokanee_typography_css', $css );

		return apply_filters( 'dokanee_typography_css_output', $css->css_output() );
	}
}

if ( ! function_exists( 'dokanee_spacing_css' ) ) {
	/**
	...
	function dokanee_spacing_css() {
		$spacing_settings = wp_parse_args(
			get_option( 'dokanee_spacing_settings', array() ),
			dokanee_spacing_get_defaults()
		);

		$og_defaults = dokanee_spacing_get_defaults( false );
		$sidebar_layout = dokanee_get_layout();

		$css = new Dokanee_CSS;

		// Top bar padding
		$css->set_selector( '.inside-top-bar' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'top_bar_top' ], $spacing_settings[ 'top_bar_right' ], $spacing_settings[ 'top_bar_bottom' ], $spacing_settings[ 'top_bar_left' ] ), dokanee_padding_css( $og_defaults[ 'top_bar_top' ], $og_defaults[ 'top_bar_right' ], $og_defaults[ 'top_bar_bottom' ], $og_defaults[ 'top_bar_left' ] ) );

		// Header padding
		$css->set_selector( '.inside-header' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'header_top' ], $spacing_settings[ 'header_right' ], $spacing_settings[ 'header_bottom' ], $spacing_settings[ 'header_left' ] ), dokanee_padding_css( $og_defaults[ 'header_top' ], $og_defaults[ 'header_right' ], $og_defaults[ 'header_bottom' ], $og_defaults[ 'header_left' ] ) );
		...
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'content_top' ], $spacing_settings[ 'content_right' ], $spacing_settings[ 'content_bottom' ], $spacing_settings[ 'content_left' ] ), dokanee_padding_css( $og_defaults[ 'content_top' ], $og_defaults[ 'content_right' ], $og_defaults[ 'content_bottom' ], $og_defaults[ 'content_left' ] ) );

		// Mobile Content padding
		$css->start_media_query( apply_filters( 'dokanee_mobile_media_query', '(max-width:768px)' ) );
		$css->set_selector( '.separate-containers .inside-article, .separate-containers .comments-area, .separate-containers .page-header, .separate-containers .paging-navigation, .one-container .site-content, .inside-page-header' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'mobile_content_top' ], $spacing_settings[ 'mobile_content_right' ], $spacing_settings[ 'mobile_content_bottom' ], $spacing_settings[ 'mobile_content_left' ] ) );
		$css->stop_media_query();
		...
		$css->add_property( 'margin', dokanee_padding_css( '0', $spacing_settings[ 'content_right' ], '0', $spacing_settings[ 'content_left' ] ), dokanee_padding_css( '0', $og_defaults[ 'content_right' ], '0', $og_defaults[ 'content_left' ] ) );
		...
		$css->add_property( 'margin', dokanee_padding_css( $spacing_settings[ 'separator' ], $spacing_settings[ 'separator' ], $spacing_settings[ 'separator' ], '0' ), dokanee_padding_css( $og_defaults[ 'separator' ], $og_defaults[ 'separator' ], $og_defaults[ 'separator' ], '0' ) );

		// Left sidebar
		$css->set_selector( '.left-sidebar.separate-containers .site-main' );
		$css->add_property( 'margin', dokanee_padding_css( $spacing_settings[ 'separator' ], '0', $spacing_settings[ 'separator' ], $spacing_settings[ 'separator' ] ), dokanee_padding_css( $og_defaults[ 'separator' ], '0', $og_defaults[ 'separator' ], $og_defaults[ 'separator' ] ) );
		...
		// Sub-menu item size
		$css->set_selector( '.main-navigation .main-nav ul ul li a' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'sub_menu_item_height' ], $spacing_settings[ 'menu_item' ], $spacing_settings[ 'sub_menu_item_height' ], $spacing_settings[ 'menu_item' ] ), dokanee_padding_css( $og_defaults[ 'sub_menu_item_height' ], $og_defaults[ 'menu_item' ], $og_defaults[ 'sub_menu_item_height' ], $og_defaults[ 'menu_item' ] ) );
		...
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'widget_top' ], $spacing_settings[ 'widget_right' ], $spacing_settings[ 'widget_bottom' ], $spacing_settings[ 'widget_left' ] ), dokanee_padding_css( $og_defaults[ 'widget_top' ], $og_defaults[ 'widget_right' ], $og_defaults[ 'widget_bottom' ], $og_defaults[ 'widget_left' ] ) );

		// Footer widget padding
		$css->set_selector( '.footer-widgets' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'footer_widget_container_top' ], $spacing_settings[ 'footer_widget_container_right' ], $spacing_settings[ 'footer_widget_container_bottom' ], $spacing_settings[ 'footer_widget_container_left' ] ), dokanee_padding_css( $og_defaults[ 'footer_widget_container_top' ], $og_defaults[ 'footer_widget_container_right' ], $og_defaults[ 'footer_widget_container_bottom' ], $og_defaults[ 'footer_widget_container_left' ] ) );

		// Footer widget separator
		$css->set_selector( '.site-footer .footer-widgets-container .inner-padding' );
		$css->add_property( 'padding', dokanee_padding_css( '0', '0', '0', $spacing_settings[ 'footer_widget_separator' ] ), dokanee_padding_css( '0', '0', '0', $og_defaults[ 'footer_widget_separator' ] ) );
		...
		// Footer padding
		$css->set_selector( '.site-info' );
		$css->add_property( 'padding', dokanee_padding_css( $spacing_settings[ 'footer_top' ], $spacing_settings[ 'footer_right' ], $spacing_settings[ 'footer_bottom' ], $spacing_settings[ 'footer_left' ] ), dokanee_padding_css( $og_defaults[ 'footer_top' ], $og_defaults[ 'footer_right' ], $og_defaults[ 'footer_bottom' ], $og_defaults[ 'footer_left' ] ) );
		...
		$sidebar = strtoupper( $dokanee_settings['sidebar_widget_background_color'] );
		$content = strtoupper( $dokanee_settings['content_background_color'] );
		...
		// Allow us to hook CSS into our output
		do_action( 'dokanee_spacing_css', $css );

		return apply_filters( 'dokanee_spacing_css_output', $css->css_output() . $output );
	}
}
...
add_action( 'wp_enqueue_scripts', 'dokanee_enqueue_dynamic_css', 50 );
/**
...
function dokanee_enqueue_dynamic_css() {
	if ( ! get_option( 'dokanee_dynamic_css_output', false ) || is_customize_preview() || apply_filters( 'dokanee_dynamic_css_skip_cache', false ) ) {
		$css = dokanee_base_css() . dokanee_font_css() . dokanee_advanced_css() . dokanee_spacing_css();
	} else {
		$css = get_option( 'dokanee_dynamic_css_output' ) . '/* End cached CSS */';
	}

	$css = $css . dokanee_no_cache_dynamic_css();

	wp_add_inline_style( 'dokanee-style', $css );
}

add_action( 'init', 'dokanee_set_dynamic_css_cache' );
/**
...
function dokanee_set_dynamic_css_cache() {
	...
	$cached_css = get_option( 'dokanee_dynamic_css_output', false );
	$cached_version = get_option( 'dokanee_dynamic_css_cached_version', '' );

	if ( ! $cached_css || $cached_version !== GENERATE_VERSION ) {
		$css = dokanee_base_css() . dokanee_font_css() . dokanee_advanced_css() . dokanee_spacing_css();

		update_option( 'dokanee_dynamic_css_output', $css );
		update_option( 'dokanee_dynamic_css_cached_version', GENERATE_VERSION );
	}
}

add_action( 'customize_save_after', 'dokanee_update_dynamic_css_cache' );
/**
