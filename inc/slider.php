...
class Dokanee_Slider {
	...
	function do_metaboxes() {
        ...
        add_meta_box( 'slider-options-box', __('Slider Options', 'dokanee' ), array( $this, 'meta_boxes_option' ), $this->post_type, 'side' );
	}
...
//        if ( isset( $wp->query_vars['post_type'] ) && $wp->query_vars['post_type'] == 'dokanee_slider' ) {
            ...
            $help_text = sprintf( __( 'Learn More: <a target="_blank" href="%s">How to Create Slider in Dokanee</a>', 'dokanee' ), 'https://wedevs.com/docs/dokan/tutorials/how-to-create-a-slider-for-homepage-using-dokan/' );
            ?>
            <script>
                jQuery(function($) {
                ...
                <tr>
                    ...
                    <td>
                        <select name="slider_pagination">
                            <option value="true"<?php selected( $slider_pagination, 'true' ); ?>><?php _e( 'Show', 'dokanee' ); ?></option>
                            <option value="false"<?php selected( $slider_pagination, 'false' ); ?>><?php _e( 'Hide', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="direction_nav">
                            <option value="true"<?php selected( $direction_nav, 'true' ); ?>><?php _e( 'Show', 'dokanee' ); ?></option>
                            <option value="false"<?php selected( $direction_nav, 'false' ); ?>><?php _e( 'Hide', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="slide_direction">
                            <option value="horizontal"<?php selected( $slide_direction, 'horizontal' ); ?>><?php _e( 'horizontal', 'dokanee' ); ?></option>
                            <option value="vertical"<?php selected( $slide_direction, 'vertical' ); ?>><?php _e( 'vertical', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="touch">
                            <option value="true"<?php selected( $touch, 'true' ); ?>><?php _e( 'Yes', 'dokanee' ); ?></option>
                            <option value="false"<?php selected( $touch, 'false' ); ?>><?php _e( 'No', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="randomize">
                            <option value="false"<?php selected( $randomize, 'false' ); ?>><?php _e( 'No', 'dokanee' ); ?></option>
                            <option value="true"<?php selected( $randomize, 'true' ); ?>><?php _e( 'Yes', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="pauseOnHover">
                            <option value="false"<?php selected( $pauseOnHover, 'false' ); ?>><?php _e( 'No', 'dokanee' ); ?></option>
                            <option value="true"<?php selected( $pauseOnHover, 'true' ); ?>><?php _e( 'Yes', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="pausePlay">
                            <option value="false"<?php selected( $pausePlay, 'false' ); ?>><?php _e( 'No', 'dokanee' ); ?></option>
                            <option value="true"<?php selected( $pausePlay, 'true' ); ?>><?php _e( 'Yes', 'dokanee' ); ?></option>
                        </select>
                    </td>
                </tr>
            </table>
    ...
    function slide_html( $args = array() ) {
        ...
        <li>
            <div class="slide-table">
                <h3 class="slide-hndle"><span><?php _e( 'Slide', 'dokanee' ); ?></span></h3>
                <table class="form-table">
                    <tr class="slider_type_select">
                        <td><?php _e( 'Slide Type', 'dokanee' ); ?></td>
                        <td>
                            <select class="slide_type" name="slide_type[]">
                                <option value="text-image"<?php selected( $slide_type, 'text-image' ); ?>><?php _e( 'Text with Image', 'dokanee' ); ?></option>
                                <option value="image"<?php selected( $slide_type, 'image' ); ?>><?php _e( 'Full Image', 'dokanee' ); ?></option>
                                <option value="video"<?php selected( $slide_type, 'video' ); ?>><?php _e( 'Full Video', 'dokanee' ); ?></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="slide_link_open[]">
                                <option value="_self"<?php selected( $slide_link_open, '_self'); ?>><?php _e( 'Open link in same window', 'dokanee' ); ?></option>
                                <option value="_blank"<?php selected( $slide_link_open, '_blank'); ?>><?php _e( 'Open link in new window', 'dokanee' ); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
    ...
    public function get_slider( $slider_id ) {
        ...
        if ( $slides ) {
            ...
            foreach ($slides as $slide) {
                ...
                $link_content = sprintf('<a href="%s" class="button" target="%s">%s</a>', esc_url( $slide_link ), $slide_link_open, __( 'Read More...', 'dokanee' ) );
