                ...
                foreach ( $sellers['users'] as $seller ) {
                    ...
                    <li class="dokan-single-seller woocommerce coloum-<?php echo esc_attr( $per_row ); ?> <?php echo ( ! $store_banner_id ) ? 'no-banner-img' : ''; ?>">
                        <div class="store-wrapper">
                            ...
                            <!-- store content -->
                            <div class="dokani-store-content <?php echo ! $store_banner_id ? esc_attr( 'default-store-banner' ) : '' ?>">
                                <div class="store-data-container">
                                    ...
                                    <div class="store-data <?php echo esc_attr( $store_open_is_on ); ?>">
                                        ...
                                        <?php if ( ! dokan_is_vendor_info_hidden( 'address' ) && $store_address ): ?>
                                            ...
                                            ?>
                                            <p class="store-address"> <i class="flaticon-placeholder-black-shape-for-localization-on-maps"></i> <?php echo wp_kses( $store_address, $allowed_tags ); ?></p>
                                        <?php endif ?>
                                    ...
                                    <!-- store footer -->
                                    <div class="store-btn">
                                      <a href="<?php echo esc_attr( $store_url ); ?>"><?php echo esc_html( 'View Store', 'dokani' ); ?></a>
                                    </div>
                                    <!-- store footer end -->
                                </div>
                            </div>
