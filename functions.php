...
if ( ! function_exists( 'dokani_setup' ) ) {
	...
	function dokani_setup() {
		...
		register_nav_menus( array( 'primary' => __( 'Primary Menu', 'dokani' ), 'top' => __( 'Top Menu', 'dokani' ), 'responsive' => __( 'Responsive Menu', 'dokani' ), 'footer_menu' => __( 'Footer Menu', 'dokani' ) ) );
		...
		// WooCommerce support.
		add_theme_support( 'woocommerce', array( 'thumbnail_image_width' => 260 ) );
...
if ( ! function_exists( 'dokani_load_customizer_files' ) ) {
	add_action( 'load_customizer_files', 'dokani_load_customizer_files' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 * @since 1.0.0
